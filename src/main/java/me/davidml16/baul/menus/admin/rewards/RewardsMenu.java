...
import me.davidml16.baul.conversation.rewards.EditRewardConversation;
import me.davidml16.baul.conversation.rewards.RewardConversation;
import me.davidml16.baul.menus.admin.type.TypeConfigMenu;
...
public class RewardsMenu extends Menu {
    ...
    public void OnPageOpened(int page) {
        ...
        Inventory gui = createInventory(45, "%baul_type% | Rewards".replaceAll("%baul_type%", id));
